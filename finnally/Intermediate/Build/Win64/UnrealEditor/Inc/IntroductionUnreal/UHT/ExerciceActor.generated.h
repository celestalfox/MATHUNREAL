...
// IWYU pragma: private, include "ExerciceActor.h"

#ifdef INTRODUCTIONUNREAL_ExerciceActor_generated_h
#error "ExerciceActor.generated.h already included, missing '#pragma once' in ExerciceActor.h"
#endif
#define INTRODUCTIONUNREAL_ExerciceActor_generated_h
...
#define FID_finnally_Source_IntroductionUnreal_ExerciceActor_h_11_ENHANCED_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AExerciceActor); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AExerciceActor); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(AExerciceActor) \
...
class AExerciceActor;

// ********** End Class AExerciceActor *************************************************************

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_finnally_Source_IntroductionUnreal_ExerciceActor_h
